...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton busbtn=(ImageButton) findViewById(R.id.busbutton);
        ImageButton trainbtn=(ImageButton) findViewById(R.id.trainbutton);
        busbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent g=new Intent(MainActivity.this,BUSES.class);
                startActivity(g);
            }
        });
        trainbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent g=new Intent(MainActivity.this,trains.class);
                startActivity(g);
            }
        });
